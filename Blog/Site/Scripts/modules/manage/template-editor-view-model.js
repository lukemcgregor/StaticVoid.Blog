define(['jquery', 'knockout', 'ace'], function ($, ko) {
    var templateEditorViewModel = function (options) {
        var self = this;
        ...
        self.noscriptMetaRefreshSelected = ko.computed(function () {
            return self.templateMode() === options.data.templateModes.noscriptMetaRefresh;
        });
        self.selectNoscriptMetaRefresh = function () {
            //TODO: Not Implemented yet
            //self.templateMode(options.data.templateModes.noscriptMetaRefresh);
            return false;
        };

        self.domRipSelected = ko.computed(function () {
            return self.templateMode() === options.data.templateModes.domRip;
        });
        self.selectDomRip = function () {
            self.templateMode(options.data.templateModes.domRip);
            return false;
        };

        self.bodyOnlySelected = ko.computed(function () {
            return self.templateMode() === options.data.templateModes.bodyOnly;
        });
        self.selectBodyOnly = function () {
            self.templateMode(options.data.templateModes.bodyOnly);
            return false;
        };

        self.noNojsFallbackSelected = ko.computed(function () {
            return self.templateMode() === options.data.templateModes.noNojsFallback;
        });
        self.selectNoNojsFallback = function () {
            //TODO: Not Implemented yet
            //self.templateMode(options.data.templateModes.noNojsFallback);
            return false;
        };

        self.noDomCustomisationSelected = ko.computed(function () {
            return self.templateMode() === options.data.templateModes.noDomCustomisation;
        });
        self.selectNoDomCustomisation = function () {
            self.templateMode(options.data.templateModes.noDomCustomisation);
            return false;
        };
